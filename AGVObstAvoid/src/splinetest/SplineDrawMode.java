...
/**
 * Enumeration for the current action to be taken when a mouse events
 * are received by SplinePanel.
 * 
 * @author Will Shackleford<shackle@nist.gov>
 */
public enum SplineDrawMode {
    START,GOAL,CONTROL_POINT,OBSTACLE,SELECT,BOUNDARY,HORZ_BOUNDARY,
    VERT_BOUNDARY,PAN,WAYPOINT,DRAW_PLANNING_RECT;
}

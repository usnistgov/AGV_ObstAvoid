...
/**
 * Class extends the Line2D.Double representation of a line.
...
public class Line2Dd extends Line2D.Double {
    ...
    public Line2Dd(Line2D.Double l2d) {
        super(l2d.getP1(),l2d.getP2());
    }

    public Line2Dd(Point2D p1, Point2D p2) {
        super(p1, p2);
    }
...
//    }
    ...
    public static Line2Dd valueOf(String s) {
        s = s.trim();
        ...
        return new Line2Dd(java.lang.Double.valueOf(x1s), java.lang.Double.valueOf(y1s),
